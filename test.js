...
console.log(englist_wordlist[0b00001101111]);
console.log(englist_wordlist[0b11001011000]);

console.log(englist_wordlist.indexOf("opera"));
console.log(util.format("%016x",englist_wordlist.indexOf("opera")));


function 十六进制转助记词(hexStr)
{
    return "";
}

function 助记词转十六进制(mnemonicArr)
{
    return "";
}
...
const device_manager = frida.getDeviceManager();
device =await frida.getUsbDevice();

let pid = device.spawn(['walletapp.safepal.io']);
console.log(pid)
